...
[SourceHut](https://sourcehut.org/blog/2026-08-27-tos-changes-and-llms/) forbids "original content written with or which facilitates the use of LLMs [...] or other generative AI technologies."

[aerynOS](https://github.com/aerynOS/.github/blob/main/CONTRIBUTING.md#llm-contributions) forbids contributions with "content generated by large language models or other probabilistic tools," citing ethics, power/water usage, quality and copyright.

[NLnet](https://nlnetlabs.nl/llm-policy/) forbids LLM-generated code and requires disclosure of LLM usage, with an exception for LLM-authored critical bug fixes.
